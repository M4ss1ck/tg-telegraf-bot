...
//                 .toFile(dest)
//                 .then(async () => {
//                     await ctx.replyWithSticker({ source: dest, filename: 'sticker.webp' }, {
//                         // @ts-expect-error emoji is defined
//                         emoji: '🤭'
//                     }).catch(console.error)
//                     const sticker = await ctx.uploadStickerFile(Input.fromLocalFile(dest))
//                     console.log(sticker)
//                     if (sticker) {
//                         await ctx.replyWithSticker(sticker.file_id).catch(console.error)
//                     }
//                     // await ctx.telegram.sendSticker(ctx.chat.id, Input.fromLocalFile(dest))
//                     try {
//                         await unlink(dest)
//                         await unlink(path)
//                     } catch (error) {
